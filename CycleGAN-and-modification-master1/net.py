...
def make_var(name, shape, trainable=True):
    return tf.compat.v1.get_variable(name, shape, trainable=trainable)
...
def batch_norm(input_, name="batch_norm"):
    with tf.compat.v1.variable_scope(name):
        input_dim = input_.get_shape()[-1]
        scale = tf.compat.v1.get_variable("scale", [input_dim],
                                          initializer=tf.compat.v1.random_normal_initializer(1.0, 0.02,
                                                                                             dtype=tf.float32))
        offset = tf.compat.v1.get_variable("offset", [input_dim], initializer=tf.compat.v1.constant_initializer(0.0))
        mean, variance = tf.compat.v1.nn.moments(input_, axes=[1, 2], keep_dims=True)
        epsilon = 1e-5
...
def max_pooling(input_, kernel_size, stride, name, padding="SAME"):
    return tf.compat.v1.nn.max_pool(input_, ksize=[1, kernel_size, kernel_size, 1], strides=[1, stride, stride, 1],
                                    padding=padding, name=name)


def avg_pooling(input_, kernel_size, stride, name, padding="SAME"):
    return tf.compat.v1.nn.avg_pool(input_, ksize=[1, kernel_size, kernel_size, 1], strides=[1, stride, stride, 1],
                                    padding=padding, name=name)
...
def relu(input_, name="relu"):
    return tf.compat.v1.nn.relu(input_, name=name)
...
def generator(image, gf_dim=64, reuse=False, name="generator"):
    ...
    with tf.compat.v1.variable_scope(name):
        ...
        output = tf.compat.v1.nn.tanh(d5)
        return output
...
def discriminator(image, df_dim=64, reuse=False, name="discriminator", buffer_use=False, buffer=None):
    with tf.compat.v1.variable_scope(name):
        ...
        if buffer_use is False:
            #            with tf.device('/gpu:0'):
            image_crop_1 = tf.compat.v1.random_crop(image, [1, 30, 30, 3], name='image_crop_1')
            image_crop_2 = tf.compat.v1.random_crop(image, [1, 30, 30, 3], name='image_crop_2')
            image_crop_4 = tf.compat.v1.random_crop(image, [1, 30, 30, 3], name='image_crop_4')
            image_crop_5 = tf.compat.v1.random_crop(image, [1, 30, 30, 3], name='image_crop_5')
            image_crop_6 = tf.compat.v1.random_crop(image, [1, 30, 30, 3], name='image_crop_6')
            image_crop_7 = tf.compat.v1.random_crop(image, [1, 30, 30, 3], name='image_crop_7')
            image_crop_3 = tf.compat.v1.random_crop(image, [1, 30, 30, 3], name='image_crop_3')
            image_crop_8 = tf.compat.v1.random_crop(image, [1, 30, 30, 3], name='image_crop_8')
            image_crop_9 = tf.compat.v1.random_crop(image, [1, 30, 30, 3], name='image_crop_9')
            image_crop_10 = tf.compat.v1.random_crop(image, [1, 30, 30, 3], name='image_crop_10')
            image_crop_11 = tf.compat.v1.random_crop(image, [1, 30, 30, 3], name='image_crop_11')
            image_crop_12 = tf.compat.v1.random_crop(image, [1, 30, 30, 3], name='image_crop_12')
            image_crop_13 = tf.compat.v1.random_crop(image, [1, 30, 30, 3], name='image_crop_13')
            image_crop_14 = tf.compat.v1.random_crop(image, [1, 30, 30, 3], name='image_crop_14')
            image_crop_15 = tf.compat.v1.random_crop(image, [1, 30, 30, 3], name='image_crop_15')
            image_ensemble = tf.compat.v1.concat(
                [image_crop_1, image_crop_2, image_crop_3, image_crop_4, image_crop_5, image_crop_6, image_crop_7,
                 image_crop_8, image_crop_9, image_crop_10, image_crop_11, image_crop_12, image_crop_13, image_crop_14,
                 image_crop_15], axis=0)
            ...
            h2 = lrelu(batch_norm(conv2d(input_=h1, output_dim=df_dim * 4, kernel_size=4, stride=2, name='d_h2_conv'),
                                  'd_bn2'))
            h3 = lrelu(batch_norm(conv2d(input_=h2, output_dim=df_dim * 8, kernel_size=4, stride=2, name='d_h3_conv'),
                                  'd_bn3'))
            output = conv2d(input_=h3, output_dim=1, kernel_size=4, stride=1, name='d_h4_conv')
        else:
            rand_seed = random.sample(range(15), 13)
            for i in range(13):
                tf.compat.v1.assign(buffer[rand_seed[i], :, :, :], tf.compat.v1.random_crop(image, [1, 70, 70, 3]))
